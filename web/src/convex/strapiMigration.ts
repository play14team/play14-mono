...
export const cleanupAllMigrationData = action({
  ...
  handler: async (
    ...
    try {
      // Note: File cleanup is now handled by the script: `pnpm convex:full-reset`
      console.log('ℹ️  For complete file cleanup, use: `pnpm convex:full-reset`');

      // Step 1: Clear all content type tables
      console.log('Step 1: Clearing all content type tables...');
      ...
      // Step 2: Clear relationship tables
      console.log('Step 2: Clearing relationship tables...');
      ...
      // Step 3: Clear migration status table
      ...
      return {
        ...
        message: `Successfully cleaned up ${totalDeletedItems} items and ${totalDeletedMappings} mappings. Use 'pnpm convex:full-reset' for file cleanup.`
      };
    } catch (error) {

...
- **IMPORTANT** Never add your name to a commit message
- **IMPORTANT** Never use `any` in Typescript. ESLint will forbid you too.
- **IMPORTANT** Always use strict Typescript syntax
